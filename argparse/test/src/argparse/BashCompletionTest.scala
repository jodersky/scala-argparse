...
object BashCompletionTest extends TestSuite {
  ...
  val tests = Tests {
    ...
    test("named multiple partial match 1") {
      ...
      parser.parser.parseResult(Seq(), line("cmd --opt")) ==> ArgParser.EarlyExit
    ...
    test("named multiple partial match 2") {
      ...
      parser.parser.requiredParam[String]("--opt")
      parser.parser.requiredParam[String]("--optimize")
      parser.parser.parseResult(Seq(), line("cmd --opti")) ==> ArgParser.EarlyExit
    ...
    test("named multiple partial match 3") {
      ...
      parser.parser.requiredParam[String]("--opt")
      parser.parser.requiredParam[String]("--optimize")
      parser.parser.parseResult(Seq(), line("cmd --optim")) ==> ArgParser.EarlyExit
    ...
    test("named multiple full match") {
      ...
      parser.parser.requiredParam[String]("--opt")
      parser.parser.requiredParam[String]("--optimize")
      parser.parser.parseResult(Seq(), line("cmd --optimize")) ==> ArgParser.EarlyExit
      parser.completions ==> List("--optimize ")
    }
    ...
    test("arg completions partial") {
      ...
      parser.parser.parseResult(Seq(), line("cmd --optimize L1")) ==> ArgParser.EarlyExit
